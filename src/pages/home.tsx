          ...
          {gameCategories.map((game, index) => {
            return (
              <Link key={index} to={game.slug}>
                <Card className="bg-gray-800/50 border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:scale-105 hover:shadow-xl cursor-pointer group backdrop-blur-sm">
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div
                        className={`w-2 h-2 rounded-full bg-gradient-to-r ${game.color} group-hover:animate-pulse`}
                      ></div>
                    </div>
                  </CardContent>
                </Card>
